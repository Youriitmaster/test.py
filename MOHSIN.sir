...
try:
    ...
    os.https://github.com/FUCKOFF/SAAHIR.git
...
def Zeek():
    os.system('clear')
    print logo1
    print '\x1b[1;91m[1]  bcN'
    time.sleep(0.10)
    print '\x1b[1;92m[2] bc'
    time.sleep(0.10)
    print '\x1b[1;95m[3] MORE INFO'
    time.sleep(0.10)
    print '\x1b[1;96m[4] bc
    time.sleep(0.10)
    print '\x1b[1;97m[5] bc'
    time.sleep(0.10)
    print '\x1b[1;91m[6] bc
    time.sleep(0.10)
...
\033[1;95mFb\033[1;97msaahir
\033[1;95myoutube\033[1;97mhttps://https://www.facebook.com/Saahir.khan.ALL.HATERX.KA.PAPA.FEEL.THE.POWER"""
